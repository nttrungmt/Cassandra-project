...
public class MainClient {
		...
		for (int i = 0; i < clientCount; i++) {
			...
			try {
				...
				while ((sCurrentLine = br.readLine()) != null) {
					...
					// check the transactions and call based on the first value
					...
					if (words[0] == "N") {
						...
						//int[] ol_i_id = null, ol_supply_w_id = null, ol_quantity = null;
						...
						//transaction.newOrder(c_id, w_id, d_id, m, ol_i_id, ol_supply_w_id, ol_quantity);
						...
						int payment = Integer.parseInt(words[4]);
	...
	public static void main(String[] args) {
		...
		if (args[0] != "D8" || args[0] != "D40") {
			System.out
					.println("Incorrect value of database. Please choose D8 or D40");
			System.exit(-1);
		}
		...
		if (args[1] != "1" || args[1] != "2") {
			System.out
					.println("Incorrect value of Nodes. Please choose 1 or 2");
			System.exit(-1);
		}
